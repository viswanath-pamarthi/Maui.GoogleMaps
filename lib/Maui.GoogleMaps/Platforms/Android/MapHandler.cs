...
using Maui.GoogleMaps.Android.Logics;
    ...
    public partial class MapHandler : ViewHandler<Map, MapView>
    {
        ...
        protected virtual void OnMapReady()
        {
            ...
            if (nativeMap != null)
            {
                ...
                onMapClickListener.Handler = this;
                onMapLongClickListener.Handler = this;
                onMyLocationButtonClickListener.Handler = this;
...
#pragma warning restore 618
        ...
        class OnMapClickListener : Java.Lang.Object, GoogleMap.IOnMapClickListener
        {
        ...
        class OnMapLongClickListener : Java.Lang.Object, GoogleMap.IOnMapLongClickListener
        {
            public MapHandler Handler { get; set; }
            public void OnMapLongClick(LatLng point)
            {
                Handler.VirtualView.SendMapLongClicked(point.ToPosition());
            }
        }

        class OnMyLocationButtonClickListener : Java.Lang.Object, GoogleMap.IOnMyLocationButtonClickListener
        {
            public MapHandler Handler { get; set; }
            public bool OnMyLocationButtonClick()
            {
                return Handler.VirtualView.SendMyLocationClicked();
            }
        }
    }
}
